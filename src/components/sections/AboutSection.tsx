...
export function AboutSection() {
    return (
        <section id="about" className="w-full px-4 md:px-20 py-20 relative">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-16 mt-24">
                {/* About Image */}
                <motion.div
                ...
                >
                    ...
                    <h3 className="text-3xl md:text-4xl font-light mb-8 uppercase">HYDRA VR</h3>
                    <p className="text-gray-300 md:text-lg mb-10 leading-relaxed text-left">
